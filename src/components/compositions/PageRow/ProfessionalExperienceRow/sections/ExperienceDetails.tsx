...
export function ExperienceDetails({ experience }: ExperienceDetailsProps) {
  ...
  return (
    <article className="professional-experience-row-details">
      <header className="professional-experience-row-details-header">
        ...
        <div>
          ...
          {experience.location || experience.companyType ? (
            <div className="professional-experience-row-company-meta">
              {experience.location ? (
                <span className="professional-experience-row-location">
                  <MapPinIcon aria-hidden="true" size="var(--icon-size-normal)" weight="fill" />
                  {experience.location}
                </span>
              ) : null}
              {experience.companyType ? (
                <span className="professional-experience-row-company-type">
        ...
        <span className="professional-experience-row-details-period">
      ...
      {experience.engagements?.length ? (
        <PanelFrame header={<PanelHeader label={t('v1.sections.clientsProjects')} />}>
          <section
            ...
            className="professional-experience-row-engagements"
          >
