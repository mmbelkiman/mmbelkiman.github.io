...
export function ContactEducationRow({
  contactLinks,
  education,
  languages,
}: ContactEducationRowProps) {
  return (
    <section aria-label="Contact links, education and languages" className="contact-education-row">
      <Grid>
        <Grid.Column weight={3}>
          <ContactLinks links={contactLinks} />
        </Grid.Column>
        <Grid.Column weight={5}>
          <Education items={education} />
        </Grid.Column>
        <Grid.Column weight={2}>
