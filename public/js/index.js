$(document).ready(function () {
	...
	function translate() {
		...
		$("#trio-b-time").html(mLanguage["trio-b-time"]);
		$("#trio-b-role").html(mLanguage["trio-b-role"]);
		$("#aulapp-time").html(mLanguage["aulapp-time"]);
		$("#aulapp-role").html(mLanguage["aulapp-role"]);
		$("#cyberIsight-time").html(mLanguage["cyberIsight-time"]);
		$("#cyberIsight-role").html(mLanguage["cyberIsight-role"]);
		$("#trio-a-time").html(mLanguage["trio-a-time"]);
		$("#trio-a-role").html(mLanguage["trio-a-role"]);
		$("#ilia-time").html(mLanguage["ilia-time"]);
		$("#ilia-role").html(mLanguage["ilia-role"]);
		$("#onebrain-time").html(mLanguage["onebrain-time"]);
		$("#onebrain-role").html(mLanguage["onebrain-role"]);
		...
		$("#pathcrypto-1").html(mLanguagePortfolio["pathcrypto-1"]);
		$("#pathcrypto-2").html(mLanguagePortfolio["pathcrypto-2"]);
		$("#pathcrypto-3").html(mLanguagePortfolio["pathcrypto-3"]);
		$("#pipoclube-1").html(mLanguagePortfolio["pipoclube-1"]);
		$("#pipoclube-2").html(mLanguagePortfolio["pipoclube-2"]);
		$("#pipoclube-3").html(mLanguagePortfolio["pipoclube-3"]);
		$("#tictac-1").html(mLanguagePortfolio["tictac-1"]);
		$("#tictac-2").html(mLanguagePortfolio["tictac-2"]);
		$("#tictac-3").html(mLanguagePortfolio["tictac-3"]);
